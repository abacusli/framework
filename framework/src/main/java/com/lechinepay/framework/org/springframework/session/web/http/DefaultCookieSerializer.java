package com.lechinepay.framework.org.springframework.session.web.http;
/*
...
public class DefaultCookieSerializer implements CookieSerializer {
    ...
    public void writeCookieValue(CookieValue cookieValue) {
        ...
        Cookie sessionCookie = new Cookie(this.cookieName,
                this.useBase64Encoding ? base64Encode(actualCookieValue) : actualCookieValue);
        ...
        if ("".equals(requestedCookieValue)) {
            ...
            // the cookie is only written at time of session creation, so we
            // rely on
            // session expiration rather than cookie expiration if remember me
            // is enabled
     ...
     * However, this can help with tracing logs of a particular user. This will
     * ensure that the value of the cookie is formatted as
     * </p>
     * <code>
     * sessionId + "." jvmRoute
     * </code>
    ...
    /**
     * Set if the Base64 encoding of cookie value should be used. This is
     * valuable in order to support
     * <a href="https://tools.ietf.org/html/rfc6265">RFC 6265</a> which
     * recommends using Base 64 encoding to the cookie value.
     *
     * @param useBase64Encoding
    ...
    /**
     * Set the request attribute name that indicates remember-me login. If
     * specified, the cookie will be written as Integer.MAX_VALUE.
     * 
     * @param rememberMeRequestAttribute
     *            the remember-me request attribute name
     * @since 1.3.0
     */
